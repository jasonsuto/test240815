package com.example.mapsglbeta2
...
import com.example.mapsglbeta2.CustomView.Companion.createTextView
import com.example.mapsglbeta2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    //region For quicker testing, force the screen on
    @RequiresApi(Build.VERSION_CODES.O_MR1)
    override fun onAttachedToWindow() {
        setTurnScreenOn(true)
        setShowWhenLocked(true)
    } //endregion For quicker testing, force the screen on
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapLoadedCallback = MapLoadedCallback {
            ...
            customViewList.add(CustomView(baseContext, "Wind Particles", "wind-particles", 2))
            ...
            //  //https://medialogicgroup.atlassian.net/browse/MAPSGLAND-105
    ...
    fun createGradientImage(width: Int, height: Int, colors: IntArray, positions: FloatArray): Bitmap {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        print("MainActivity | onConfigurationChanged")
